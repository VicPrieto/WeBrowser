    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnBack.setOnClickListener{
            if(wbvSite.canGoBack()){
                ...
                Toast.makeText(this@MainActivity, "Não existe página anterior", Toast.LENGTH_LONG).show()
            }
        }
        ...
        btnNext.setOnClickListener{
            if(wbvSite.canGoForward()){
                ...
                Toast.makeText(this@MainActivity, "Não existe próxima página", Toast.LENGTH_LONG).show()
            }
        }
